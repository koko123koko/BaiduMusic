...
//                            if (msg.what == 101 && msg.arg1 == i){
//                                songInfoBeanList.add((SongInfoBean) msg.obj);
//                            }
//
//
//                            return false;
...
//                    });
//
//                    MyPool.getInstance().getExecutorService().execute(new MyRunnable(url,handler,i));
                    StringRequest stringRequest = new StringRequest(url, new Response.Listener<String>() {

                        @Override
                        public void onResponse(String response) {
                            response = response.substring(1, response.length() - 2);
//                            Log.d("SongListFrag", response);
                ...
                final InfoBeanEvent event = new InfoBeanEvent();
...
//                        // intent.putParcelableArrayListExtra("songinfo", (ArrayList<? extends Parcelable>) songInfoBeanMap);
